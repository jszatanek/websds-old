  ...
  */
  private boolean insertDocument(String pLanguageId, String pArticleId) throws IOException {
    ...
    try {
      ...
      sql = " insert into WS_DOCUMENT(language_id, article_id, last_updated, file_size) "+
           " values(?,?, now(),?)";
      super.createPreparedStatement(sql);
      super.getPreparedStatement().setString(1,pLanguageId);
      super.getPreparedStatement().setString(2,pArticleId);
      super.getPreparedStatement().setString(3,fileSize);
      super.execDML();
      ...
      sql = "INSERT INTO WS_DOCUMENT_BLOB (DOCUMENT_ID,  MIME_TYPE, CONTENT_TYPE, PHYSICAL_FILE_NAME, BLOB_CONTENT) VALUES (?,?,?,?,?)";
  ...
  private boolean updateDocument() throws IOException {
    ...
    try {
      ...
      if (getNextRow()) {
            ...
            super.getPreparedStatement().setString(2,fileSize);
            super.execDML();
