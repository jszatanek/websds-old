...
<BODY>
  ...
  <TD valign=top>
      ...
      <tr>
        <TD class="fieldHeadingW"><B>Please select a market : </B></td>
   ...
   <% 
    ...
    <%
        ...
        <tr>
               <% String wSearchProfile=""; %>
               <TD class="fieldHeadingW"><B>Enter part number: </B></td>
               <TD class="fieldInputW"><input type=text name="pSearchProfile" value="<%= wSearchProfile%>" >&nbsp;&nbsp; </td>
               &nbsp&nbsp 
<% //               <input type="submit" name="pAction" value="Search SDS" class="but" onClick="this.clicked=true;"></TD> %>
...
<% //               <input type="submit" name="OK" value="OK" onclick="if(document.form1.pLanguage[document.form1.pLanguage.selectedIndex].value =='null'){alert('Please select market');return false;} " > %>
               <input type="submit" name="OK" value="  OK  " onClick="this.clicked=true;" > 
      </TD></tr>
      <tr><td>&nbsp;</td></tr>
